-- Correccion ordenada para recursion RLS.
-- Ejecuta este archivo completo en Supabase SQL Editor.
-- No usa DROP FUNCTION ... CASCADE; primero elimina politicas dependientes.

-- 1) Eliminar politicas que dependen de current_app_role().
...
-- 2) Reemplazar funcion de rol sin recursion.
...
-- 3) Politicas de profiles simples: sin current_app_role(), para cortar recursion.
...
-- 4) Politicas principales con funcion corregida.
